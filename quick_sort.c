...
static int	less_pivot(t_list *stack, int pivot, int size, int rot)
{
	int		less;
	t_list	*head;
	int		stack_size;
...
static int	more_pivot(t_list *stack, int pivot, int size, int rot)
{
	int		more;
	t_list	*head;
	int		stack_size;
...
static int	right_sort(t_list **a, t_list **b, int size)
{
	...
	while ((!stack_ascending(*a, iter) ||  \
			less_pivot(*a, pivot, size - put - rot, rot)) && iter-- && ++count)
	{
...
static void	left_sort(t_list **a, t_list **b, int size)
{
	...
	while ((!stack_descending(*b, iter) || \
			more_pivot(*b, pivot, size - put - rot, rot)) && iter-- && ++count)
	{
